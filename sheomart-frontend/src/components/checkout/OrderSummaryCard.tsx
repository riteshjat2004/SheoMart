  ...
  return (
    <section className="rounded-2xl border border-stone-200 bg-white p-6 shadow-sm dark:border-stone-800 dark:bg-stone-900">
      ...
      <div className="mt-5 space-y-3 text-sm">
        <div>
          <p className="text-stone-500">Store</p>
        ...
        <div className="flex justify-between border-t border-stone-200 pt-4 text-base font-semibold text-stone-900 dark:border-stone-800 dark:text-stone-50">
          <span>Final Payable Amount</span>
          <span>{money(grandTotal)}</span>
        </div>
      </div>
      <dl className="mt-5 grid gap-3 border-t border-stone-200 pt-5 text-sm dark:border-stone-800">
        <div className="flex justify-between gap-4">
          <dt className="text-stone-500">Estimated pickup</dt>
          <dd className="text-right font-semibold">{estimatedPickup}</dd>
        </div>
        <div className="flex justify-between gap-4">
      ...
      <label className="mt-5 flex items-start gap-3 border-t border-stone-200 pt-5 text-sm text-stone-600 dark:border-stone-800 dark:text-stone-300">
        <input
          type="checkbox"
        ...
        />
        <span>I agree to SheoMart&apos;s terms and pickup policy.</span>
      </label>
      <Button
        type="button"
